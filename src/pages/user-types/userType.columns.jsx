...
export const userTypeColumns = ({ page, limit, onEdit, onDelete }) => [
    {
        header: "No",
    ...
    },
    {
        ...
        accessor: "usertype_code",
    },
    {
        header: "User Type Name",
        accessor: "usertype_name",
    },
    {
        header: "Created By",
        ...
        render: (row) => (
            <div className="flex items-center gap-2">
                <Button
                    ...
                    onClick={() => onEdit(row.usertype_id)}
                >
                    <Pencil size={14} />
                </Button>
                <Button
                    variant="danger"
                    className="h-7 min-w-7 px-2 text-xs flex items-center justify-center"
                    onClick={() => onDelete(row.usertype_id)}
                >
                    <Trash2 size={14} />
                </Button>
            </div>
